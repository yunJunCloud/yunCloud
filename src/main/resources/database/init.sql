--init user
CREATE TABLE IF NOT EXISTS `yun_user` (
...
CREATE TABLE IF NOT EXISTS `yun_role` (
                        `id` int NOT NULL AUTO_INCREMENT COMMENT '主键id',
...
CREATE TABLE IF NOT EXISTS `yun_permission` (
                        `id` int NOT NULL AUTO_INCREMENT COMMENT '主键id',
...
CREATE TABLE IF NOT EXISTS `yun_user_role` (
...
CREATE TABLE IF NOT EXISTS `yun_role_permission` (
                        `role_id` int NOT NULL COMMENT '角色id',
...
CREATE TABLE IF NOT EXISTS `yun_code` (
